    ...
    <table border="1">
        ...
        <tr>
            ...
            <td><?php if(!hasA($show['Horario'])){
                $tempVar = round($show['Horario'] * 24).':00';
                echo round($show['Horario'] * 24).':00';
            }else {
                $tempVar = $show['Horario'];
                echo $show['Horario'];
            } ?></td>
            ...
            <td><a href="editgdl.php?ids='<?php echo $show['ID_SQL'] ?>'?hor='<?php echo $tempVar?>'"><button type="button" class="btn btn-succes">Modificar</button></a></td>
        </tr>
        <?php } $con->close()?>
    </table>
